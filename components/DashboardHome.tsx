...
export default function DashboardHome({ onViewChange }: DashboardHomeProps) {
  ...
  const stats = [
    { title: 'Total Pengajuan', value: '8', icon: <Description />, color: theme.palette.primary.main },
    { title: 'Diproses', value: '2', icon: <Pending />, color: theme.palette.warning.main },
    { title: 'Selesai', value: '5', icon: <CheckCircle />, color: theme.palette.success.main },
    { title: 'Perlu Tindakan', value: '1', icon: <TrendingUp />, color: theme.palette.error.main },
  ];
